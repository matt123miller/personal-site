...
function PaintsList(props) {
  ...
  const sortChanged = (e) => {
    ...
    updateSort(prevState => { return { ...prevState, ...updatedValues } });
  }
  ...
  return (
    <div>
      <div className="paint-controls mb-8">
        <input className="paint-search" type="text" name="SearchBar" id="SearchBar" placeholder="Search for a paint"
          onChange={searchTextChanged} />

        <div className="filters mt-4">

          <FilterButton title="A to Z" filterKey="AlphabeticalAsc" isActive={selectedSorts.AlphabeticalAsc} sortChanged={sortChanged} />
          <FilterButton title="Z to A" filterKey="AlphabeticalDesc" isActive={selectedSorts.AlphabeticalDesc} sortChanged={sortChanged} />
          <FilterButton title="Light to Dark" filterKey="LightToDark" isActive={selectedSorts.LightToDark} sortChanged={sortChanged} />
          <FilterButton title="Dark to Light" filterKey="DarkToLight" isActive={selectedSorts.DarkToLight} sortChanged={sortChanged} />
