<template>
    <div
        class="flex bg-white border-b border-grey-lighter fixed pin-t pin-x z-100 h-16 items-center"
    >
            ...
            <div class="flex items-center -mx-6">
                ...
                <div class="flex flex-grow items-center lg:w-3/4 xl:w-4/5">
                    <div class="w-full lg:px-6 lg:w-3/4 xl:px-12">
                        <div class="relative">
                            <em>Title of the page/post goes here</em>
                        </div>
                    </div>
                    ...
                    <div
                        id="sidebar-close"
                        class="hidden flex px-6 items-center lg:hidden"
                    >
                        <svg
                            class="fill-current w-4 h-4 cursor-pointer text-grey"
                            role="button"
